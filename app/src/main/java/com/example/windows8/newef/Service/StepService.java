...
package com.example.windows8.newef.Service;
...
import com.example.windows8.newef.Step.CaloriesNotifier;
import com.example.windows8.newef.Step.DistanceNotifier;
import com.example.windows8.newef.Step.PaceNotifier;
import com.example.windows8.newef.Step.PedometerSettings;
import com.example.windows8.newef.Step.SpeakingTimer;
import com.example.windows8.newef.Step.SpeedNotifier;
import com.example.windows8.newef.Step.SportUtils;
import com.example.windows8.newef.Step.StepDetector;
import com.example.windows8.newef.Step.StepDisplayer;
import com.example.windows8.newef.activity.MainActivity;
import com.example.windows8.newef.activity.SportActivity;
...
//                System.currentTimeMillis());
        ...
        Notification notification2 = new NotificationCompat.Builder(this)
                ...
                .build();
        notification2.flags = Notification.FLAG_NO_CLEAR | Notification.FLAG_ONGOING_EVENT;
        Intent pedometerIntent = new Intent();
        pedometerIntent.setComponent(new ComponentName(this, SportActivity.class));
        pedometerIntent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
        PendingIntent contentIntent = PendingIntent.getActivity(this, 0,
                pedometerIntent, 0);
        notification2.contentIntent = contentIntent;
//        notification2.setLatestEventInfo(this, text,
//                getText(R.string.notification_subtitle), contentIntent);
        NotificationManager notificationManager = (NotificationManager) this.getSystemService(this.NOTIFICATION_SERVICE);
        /**发起通知**/
        mNM.notify(R.string.app_name, notification2);
    }
