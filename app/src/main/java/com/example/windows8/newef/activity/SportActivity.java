...
import com.example.windows8.newef.Service.StepService;
import com.example.windows8.newef.Step.PedometerSettings;
import com.example.windows8.newef.Step.Settings;
...
public class SportActivity extends AppCompatActivity {
    ...
    private void startStepService() {
        if (!mIsRunning) {
            ...
            mIsRunning = true;
            startService(new Intent(SportActivity.this,
                    StepService.class));
        }
    }
    ...
    private void bindStepService() {
        ...
        bindService(new Intent(SportActivity.this,
    ...
    private void stopStepService() {
        ...
        if (mService != null) {
            ...
            stopService(new Intent(SportActivity.this,
                    StepService.class));
        }
        mIsRunning = false;
    }
