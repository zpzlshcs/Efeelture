...
public class MyMimeMap {
    private static final HashMap<String, String> mapSimple = new HashMap<String, String>();
    private static final HashMap<String, String> mapAll = new HashMap<String, String>();
    /**
     *  常用"文件扩展名—MIME类型"匹配表。
