package com.example.windows8.newef.Step;
...
public class SportUtils implements TextToSpeech.OnInitListener {
    private static final String TAG = "SportUtils";
    private Service mService;

    private static SportUtils instance = null;

    private SportUtils() {
    }
     
    public static SportUtils getInstance() {
        if (instance == null) {
            instance = new SportUtils();
        }
        return instance;
    }
